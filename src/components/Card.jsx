    ...
    <div className="bg-gradient-to-br from-white to-orange-50 rounded-lg shadow-md hover:shadow-lg border border-gray-100 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
      <div className="p-8 flex flex-col h-full">
        ...
        <div className="flex items-center mb-4">
          ...
          <a href={`${basePath}?country=${encodeURIComponent(country)}`} className="text-lg text-primary-700 hover:underline">
            {country}
          </a>
        </div>
        ...
        <div className="flex items-center mb-4">
          ...
          <a href={`${basePath}?category=${encodeURIComponent(category)}`} className="text-primary-700 hover:underline">
            {category}
          </a>
        </div>
        ...
        <div className="flex items-center mb-6">
          ...
          <a href={`${basePath}?thematic=${encodeURIComponent(description)}`} className="text-gray-600 hover:text-primary-600">
            {description}
          </a>
        </div>
